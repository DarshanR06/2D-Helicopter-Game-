...
void gameStartDisplay(){
    ...
    glClear(GL_COLOR_BUFFER_BIT);
	display_string(100, 100, "ARCHERY GAME");
	display_string(200, 600, "KEYBOARD");
	display_string(250, 560, "PRESS 'SPACE BAR' TO RELEASE ARROWS");
	display_string(250, 520, "PRESS 'UP ARROW KEY' TO MOVE UP");
	display_string(250, 480, "PRESS 'DOWN ARROW KEY' TO MOVE DOWN");
	display_string(200, 400, "INSTRUCTIONS");
	display_string(250, 360, "DESTROY TARGETS TO WIN");
	display_string(250, 320, "WHEN TARGET HITS GROUND YOU LOOSE");
	display_string(200, 240, "PRESS 'P' TO PLAY GAME");
	display_string(200, 200, "PRESS 'Q' TO QUIT THE GAME");
	glutPostRedisplay();
	glutSwapBuffers();
	glFlush();
}
